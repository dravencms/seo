...
class RobotsGrid extends BaseControl
{
     ...
     */
    public function __construct(RobotsRepository $robotsRepository, BaseGridFactory $baseGridFactory, EntityManager $entityManager, LocaleRepository $localeRepository)
    {
        parent::__construct();
